...
from dotenv import load_dotenv  # Adicionado para carregar API key
    ...
    try:
        ...
        def generate():
            ...
            try:
                            ...
                            try:
                                ...
                                if 'choices' in json_data and len(json_data['choices']) > 0:
                                    ...
                                    if 'delta' in choice and 'content' in choice['delta']:
                                        data_content = choice['delta']['content']
                                        complete_data += data_content
                                        yield data_content
                ...
                confirmation.process_confirmation(user_input, user_token, history, complete_data, payload, OPENAI_API_URL)
            except Exception as e:
